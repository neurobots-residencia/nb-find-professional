  ...
  return (
    <div className=" bg-telaInicial min-h-screen bg-no-repeat bg-cover bg-center bg-fixed sm:max-w-full  md:max-w-5xl lg:max-w-6xl xl:max-w-full ">
      ...
      <p className="text-2xl sm:text-xl">A Neurobots existe para tornar a vida das pessoas
          ...
          <button 
            onClick={trocarTela} 
            className= " bg-corAzul px-16 py-5 rounded-full w-1/2 items-center text-white text-lg hover:bg-azulEscuro ease-linear duration-300 sm:text-base sm:px-6 xm:text-sm xm:px-1 md:px-5"
          >
