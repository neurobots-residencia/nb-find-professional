...
function TelaInicial() {
  ...
  return (
    <div className=" bg-telaInicial min-h-screen bg-no-repeat bg-cover bg-center bg-fixed sm:max-w-full  md:max-w-5xl lg:max-w-6xl xl:max-w-full ">
        <div className="w-3/6 flex flex-col h-screen ml-24 justify-center text-white  ">
          ...
          <button  onClick={trocarTela} className= "bg-emerald-500 px-16 py-5 rounded-full w-1/2 items-center text-white text-lg hover:bg-emerald-400" >
