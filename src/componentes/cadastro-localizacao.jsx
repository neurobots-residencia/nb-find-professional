        ...
        >
          ...
          <div className="flex flex-col gap-6">
            <input
              id="cep"
              placeholder="CEP*"
              className={`outline-azulEscuro  placeholder-gray-700 border p-6  h-14 rounded border-gray-500 ${
          ...
          <div className=" flex gap-4">
            ...
            <input
              placeholder="Estado"
              className="outline-azulEscuro placeholder-gray-700 p-6 w-52 border h-14 rounded border-gray-500"
              type="text"
              {...register("estado")}
            />
          </div>
