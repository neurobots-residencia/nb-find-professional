        ...
        >
          ...
          <div className=" flex gap-6">
            <input
              ...
              className="outline-azulEscuro placeholder-gray-700 p-4 w-64 border h-14 rounded border-gray-500 mr-0.5 "
              type="text"
            />
            {errors.nome && (
            ...
            <input
              ...
              className="outline-azulEscuro placeholder-gray-700 p-4 w-64 border h-14 rounded border-gray-500 mr-0.5 text-sm"
              type="text"
            />
            {errors.whatsapp && (
          ...
          <input
            placeholder="Email*"
            className="outline-azulEscuro placeholder-gray-700 p-6 border h-14 rounded border-gray-500"
            type="email"
            {...register("email", {
              required: "Campo obrigatório",
              pattern: {
          ...
          <div className=" flex gap-6">
            ...
            <Controller
              ...
              render={({ field }) => (
                <select {...field} 
                className="outline-azulEscuro p-4 w-64 border h-14 rounded border-gray-500 mr-0.5 text-sm">
